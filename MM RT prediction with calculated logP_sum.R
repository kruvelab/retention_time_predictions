...
for(i in 1:669) { if (is.nan(dataset[i,218])) {
  dataset[i,218] <-dataset[i,210]  }
}
...
for(i in 1:669) { if (is.na(dataset[i,1])) {
  dataset[i,1] <-TRUE  }
}
...
saveRDS(regressor_RF,  "regressorRF for mixed mode 16062021.rds")
#-------------------------Validation--------------------------------
...
p10+my_theme
ggsave("dotplot x boxplot for training set - Mixed mode .svg",
       width=10,
       height=10,
       units="cm")
...
ggsave("dotplot x boxplot for test set - Mixed mode.svg",
       width=10,
       height=10,
       units="cm")
...
plot_grid(p4+my_theme, p5+my_theme,p10+my_theme,p11+my_theme, 
          labels = c("a) Traning set mixed-C18 ", "b) Test set mixed-C18 ", "c) Training set reversed-C18", " d) Test set reversed-C18"),
          align = "h",
          hjust = 0.1, vjust = 1,
          label_x = 0.3,
          label_y = 0.98,
...
p12 <- ggplot(data=Important_factors_in_RF)+
...
p12 + my_theme
ggsave("feature importance RF in mixed mode.svg",
       width=10,
       height=10,
       units="cm")

plot_grid(p9+my_theme, p12+my_theme,
          labels = c("a) Predictions for mixed-C18", "b) Important variables in RF model"),
          align = "h",
          hjust = 0.1, vjust = 0.8,
          label_x = 0.3,
          label_y =0.98,
          ...
          label_colour = basecolor,
          label_fontface = "plain")
ggsave("prediction of RF in mixed-C18.svg",
       width = 30,
       height = 20/668*380,
       units = "cm")
plot_grid(p1+my_theme, p7+my_theme,
          labels = c("a) Reversed-C18", "b)Mixed-C18"),
          align = "h",
          hjust = 0.1, vjust = 0.8,
          label_x = 0.3,
          label_y =0.98,
          ...
          label_colour = basecolor,
          label_fontface = "plain")
ggsave("linear model with logP for MM and RP.svg",
       width = 30,
       height = 20/668*380,
       units = "cm")
